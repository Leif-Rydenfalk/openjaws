...
Why is it so non robust?? the error logging is horrible, the error handling is worse, it gives up instantly or tries the exact same thing 100 times without any change, its not typed...